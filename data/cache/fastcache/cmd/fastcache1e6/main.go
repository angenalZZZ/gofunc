...
// cache1.benchmark(4CPU+16G+MHD) GET:2000w/Qps SET:200w/Qps FLUSH:0.4s
// cache2.benchmark(8CPU+16G+SSD) GET:2000w/Qps SET:200w/Qps FLUSH:0.1s
// buntdb-benchmark(8CPU+16G+SSD) GET:500w/Qps  SET:23w/Qps
