...
// IBus a global interface(subscribe, publish, control) bus behavior
type IBus interface {
	BusController
	BusSubscriber
	BusPublisher
...
func (bus *Bus) doPublish(handler *eventHandler, args ...interface{}) {
...
func (bus *Bus) setUpPublish(callback *eventHandler, args ...interface{}) []reflect.Value {
