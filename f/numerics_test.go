...
func TestIsNegative(t *testing.T) {
	...
	for _, test := range tests {
		actual := f.IsNegative(test.param)
		if actual != test.expected {
...
func TestIsNonNegative(t *testing.T) {
	...
	for _, test := range tests {
		actual := f.IsNonNegative(test.param)
		if actual != test.expected {
...
func TestIsPositive(t *testing.T) {
	...
	for _, test := range tests {
		actual := f.IsPositive(test.param)
		if actual != test.expected {
...
func TestIsNonPositive(t *testing.T) {
	...
	for _, test := range tests {
		actual := f.IsNonPositive(test.param)
		if actual != test.expected {
...
func TestInRangeInt(t *testing.T) {
	...
	for _, test := range testAsInts {
		actual := f.InRangeInt(test.param, test.left, test.right)
		if actual != test.expected {
...
func TestInRangeFloat32(t *testing.T) {
	...
	for _, test := range tests {
		actual := f.InRangeFloat32(test.param, test.left, test.right)
		if actual != test.expected {
...
func TestInRangeFloat64(t *testing.T) {
	...
	for _, test := range tests {
		actual := f.InRangeFloat64(test.param, test.left, test.right)
		if actual != test.expected {
...
func TestInRange(t *testing.T) {
	...
	for _, test := range testsInt {
		actual := f.InRange(test.param, test.left, test.right)
		if actual != test.expected {
