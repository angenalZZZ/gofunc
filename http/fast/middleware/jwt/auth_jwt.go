...
type Config struct {
	...
	PayloadFunc func(data interface{}) g.Map
...
func (mw *Config) GetClaimsFromJWT(c *fast.Ctx) (g.Map, error) {
...
func ExtractClaims(c *fast.Ctx) g.Map {
...
func ExtractClaimsFromToken(token *jwt.Token) g.Map {
	if token == nil {
		return make(g.Map)
	}
