...
import (
	"fmt"
	"github.com/angenalZZZ/gofunc/http/longpoll"
	"log"
	"net/http"
)

func main() {
	manager, err := longpoll.StartLongpoll(longpoll.Options{
		LoggingEnabled:                 true,
...
func getUserActionHandler(manager *longpoll.LongpollManager) func(w http.ResponseWriter, r *http.Request) {
...
func getEventSubscriptionHandler(manager *longpoll.LongpollManager) func(w http.ResponseWriter, r *http.Request) {
	// Creates closure that captures the LongpollManager
