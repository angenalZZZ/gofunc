...
func testEventsManager() *longpoll.LongpollManager {
	var err error
	eventsManager, err := longpoll.StartLongpoll(longpoll.Options{
		LoggingEnabled: true,
	})
	if err != nil {
...
func testServer() (*url.URL, *longpoll.LongpollManager) {
...
func testAuthServer(username, password string) (*url.URL, *longpoll.LongpollManager) {
	eventsManager := testEventsManager()
